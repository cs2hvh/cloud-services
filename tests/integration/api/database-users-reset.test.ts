...
describe('POST /api/services/database/users/reset', () => {
  ...
  describe('Success Cases', () => {
    it('TC-DB-044: should reset user password and return new password', async () => {
      ...
      expect(data.password.length).toBeGreaterThan(12);
    });
    ...
    it('should generate strong password', async () => {
      ...
      expect(data.password.length).toBeGreaterThan(12);
      expect(data.password).toMatch(/[A-Z]/); // Has uppercase
      expect(data.password).toMatch(/[a-z]/); // Has lowercase
      expect(data.password).toMatch(/[0-9]/); // Has numbers
    });
  ...
  describe('Authorization Tests', () => {
    it('should reject reset for cluster owned by different user', async () => {
