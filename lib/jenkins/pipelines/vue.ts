...
export function createVuePipeline(
  ...
  // Vue apps serve on port 3000 in production
            ...
            sh(
              script: '''
                ...
                if [ -f vite.config.js ] || [ -f vite.config.ts ]; then
                  echo 'Vite configuration found (Vue 3 with Vite)'
                elif [ -f vue.config.js ]; then
                  echo 'Vue CLI configuration found'
                else
                  echo 'WARNING: No vite.config.js/ts or vue.config.js found, using default settings'
                fi
            ...
            sh(
              script: '''
                if [ -f Dockerfile ]; then
                  ...
                  echo 'Generating default Vue.js Dockerfile'
...
# Vue with Vite outputs to 'dist', Vue CLI also outputs to 'dist'
