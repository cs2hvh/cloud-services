    ...
    Tables: {
      ...
      game_servers: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "game_servers_host_id_fkey";
            columns: ["host_id"];
            isOneToOne: false;
            referencedRelation: "game_hosts";
            referencedColumns: ["id"];
          },
        ];
      };
      ...
      game_server_plans: {
        ...
        Relationships: [
          {
            foreignKeyName: "game_server_plans_game_type_fkey";
            columns: ["game_type"];
            isOneToOne: false;
      ...
      game_server_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "game_server_events_server_id_fkey";
            columns: ["server_id"];
            isOneToOne: false;
