...
export const Users = {
  ...
  get_by_id: async (userId: string): Promise<UserProfile | null> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting user by id: ${error.message}`)
        return null
      }
      return data
    } catch (err) {
  ...
  get_by_email: async (email: string): Promise<(UserProfile & { email: string }) | null> => {
    try {
      const supabase = await createServiceClient()
      const { data: authUser, error: authError } = await supabase.auth.admin.listUsers()
      
      if (authError) {
        console.log(`[Supabase] Error while getting user by email: ${authError.message}`)
        return null
      }
      ...
      if (profileError) {
        console.log(`[Supabase] Error while getting user profile: ${profileError.message}`)
        return null
      }
  ...
  get_all: async (): Promise<UserProfile[]> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting all users: ${error.message}`)
        return []
      }
      return data || []
    } catch (err) {
  ...
  get_by_discord: async (discordId: string): Promise<UserProfile | null> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting user by discord: ${error.message}`)
        return null
      }
      return data
    } catch (err) {
  ...
  get_by_steam: async (steamId: string): Promise<UserProfile | null> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting user by steam: ${error.message}`)
        return null
      }
      return data
    } catch (err) {
  ...
  create: async (props: TablesInsert<'user_profiles'>): Promise<string | null> => {
    try {
      const supabase = await createClient()
      const { data, error } = await supabase
        .from('user_profiles')
      ...
      if (error) {
        console.log(`[Supabase] Error while creating user profile: ${error.message}`)
        return null
      }
      return data.id
    } catch (err) {
  ...
  update: async (id: string, props: TablesUpdate<'user_profiles'>): Promise<boolean> => {
    try {
      const supabase = await createClient()
...
export const Projects = {
  ...
  get_by_id: async (id: string): Promise<Project | null> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting project by id: ${error.message}`)
        return null
      }
      return data
    } catch (err) {
  ...
  get_all_by_user: async (userId: string): Promise<Project[]> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting projects by userId: ${error.message}`)
        return []
      }
      return data || []
    } catch (err) {
  ...
  create: async (props: TablesInsert<'projects'>): Promise<string | null> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while creating project: ${error.message}`)
        return null
      }
      return data.id
    } catch (err) {
  ...
  update: async (id: string, props: TablesUpdate<'projects'>): Promise<boolean> => {
    try {
      const supabase = await createClient()
      const { error } = await supabase
        .from('projects')
      ...
      if (error) {
        console.log(`[Supabase] Error while updating project: ${error.message}`)
        return false
      }
      return true
    } catch (err) {
  ...
  delete: async (id: string): Promise<boolean> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while deleting project: ${error.message}`)
        return false
      }
      return true
    } catch (err) {
  ...
  get_logs: async (projectId: string): Promise<ProjectLog[] | null> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting project logs: ${error.message}`)
        return null
      }
      return data
    } catch (err) {
  ...
  add_log: async (props: TablesInsert<'project_logs'>): Promise<boolean> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while creating project log: ${error.message}`)
        return false
      }
      return true
    } catch (err) {
  ...
  count_all: async (): Promise<number> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while counting projects: ${error.message}`)
        return 0
      }
      return count || 0
    } catch (err) {
...
export const GameServers = {
  get_by_id: async (id: number): Promise<GameServer | null> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting game server by id: ${error.message}`)
        return null
      }
      return data
    } catch (err) {
  ...
  get_by_user: async (userId: string): Promise<GameServer[]> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting game servers by user: ${error.message}`)
        return []
      }
      return data || []
    } catch (err) {
      console.log(`[Supabase] Error while getting game servers by user: ${err}`)
      return []
    }
  },
  ...
  get_by_project: async (projectId: string): Promise<GameServer[]> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting game servers by project: ${error.message}`)
        return []
      }
      return data || []
    } catch (err) {
      console.log(`[Supabase] Error while getting game servers by project: ${err}`)
      return []
    }
  },

  create: async (props: TablesInsert<'game_servers'>): Promise<number | null> => {
    try {
      const supabase = await createClient()
      const { data, error } = await supabase
        .from('game_servers')
      ...
      if (error) {
        console.log(`[Supabase] Error while creating game server: ${error.message}`)
        return null
      }
      return data.id
    } catch (err) {
  ...
  update: async (id: number, props: TablesUpdate<'game_servers'>): Promise<boolean> => {
    try {
      const supabase = await createClient()
      const { error } = await supabase
        .from('game_servers')
      ...
      if (error) {
        console.log(`[Supabase] Error while updating game server: ${error.message}`)
        return false
      }
      return true
    } catch (err) {
  ...
  delete: async (id: number): Promise<boolean> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while deleting game server: ${error.message}`)
        return false
      }
      return true
    } catch (err) {
...
export const Products = {
  get_by_id: async (id: string): Promise<Product | null> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting product by id: ${error.message}`)
        return null
      }
      return data
    } catch (err) {
  ...
  get_all: async (): Promise<Product[]> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting all products: ${error.message}`)
        return []
      }
      return data || []
    } catch (err) {
  ...
  get_by_type: async (type: string): Promise<Product[]> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting products by type: ${error.message}`)
        return []
      }
      return data || []
    } catch (err) {
...
export const Locations = {
  get_all: async (): Promise<Location[]> => {
    try {
      ...
      if (error) {
        console.log(`[Supabase] Error while getting locations: ${error.message}`)
        return []
      }
      return data || []
    } catch (err) {
