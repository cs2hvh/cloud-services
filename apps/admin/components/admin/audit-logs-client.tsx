...
import { AuditLogTable, type AuditLogEntry } from "@admin/components/admin/audit-log-table";
import { AuditLogDetailModal } from "@admin/components/admin/audit-log-detail-modal";
