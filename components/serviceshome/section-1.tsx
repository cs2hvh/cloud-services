...
export function ServicesHomeSectionOne({
  badge,
  title,
  description,
  primaryAction,
      ...
      <div className="relative z-10 mx-auto flex h-full w-full max-w-[1437px] px-6 lg:px-[72px]">
        <div className="flex w-full flex-col items-start gap-12 py-16 lg:flex-row lg:items-center lg:justify-between lg:gap-[96px] lg:py-0">
          <div className={cn("w-full max-w-[540px]", imageLeft && "lg:order-2")}>
            ...
            <h1
              className={cn(
                "mt-3 text-[40px] leading-[1] font-normal sm:text-[48px] lg:mt-25 lg:text-[64px]",
            ...
            <p
              className="mt-5 max-w-[32rem] text-[16px] leading-[1.4] font-light text-white/80 sm:text-[18px] lg:mt-10 lg:max-w-[462px] lg:text-[20px] lg:leading-[27px]"
              style={{ fontFamily: "Inter, sans-serif" }}
            >
              {description}
            </p>
            ...
            {(primaryAction || secondaryAction) && (
              <div className="mt-10 flex flex-wrap items-center gap-4 lg:mt-[72px] lg:gap-[30px]">
                {primaryAction ? (
                  <Link
