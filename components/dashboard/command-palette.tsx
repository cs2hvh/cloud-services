...
const DESTINATIONS: Dest[] = [
    ...
    // Hidden with Game Servers (hv, 2026-09-14):    { label: "Game Servers", href: "/dashboard/services/game", group: "Services", icon: Boxes, keywords: "minecraft rust cs2 fivem gaming" },
    // Hidden with Game Servers (hv, 2026-09-14):    { label: "Deploy Game Server", href: "/dashboard/services/game/deploy", group: "Services", icon: Plus, keywords: "minecraft rust new game" },
    ...
    { label: "Billing", href: "/dashboard/billing", group: "Account", icon: CreditCard, keywords: "credits balance invoice payment" },
