  ...
  return (
    <PageCanvas>
      <Hero
        ...
        title="Model"
        accent="catalog"
        caption={`${models.length} models from ${providers.length - 1} labs proxied through OpenRouter. Pass any model_id directly to /v1/chat/completions — the catalog is yours.`}
        size="md"
      />
