        ...
        <div className="flex flex-col gap-4 px-5 py-5 sm:px-6 sm:py-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="grid grid-cols-2 gap-3 sm:min-w-[220px]">
            <div className="border border-white/[0.08] bg-white/[0.04] px-3 py-2.5">
              <div className="text-[10px] font-semibold uppercase tracking-[0.16em] text-white/35">Progress</div>
              <div className="mt-1 text-lg font-semibold text-white">{currentStep} / {STEP_META.length}</div>
            </div>
            <div className="border border-white/[0.08] bg-white/[0.04] px-3 py-2.5">
              <div className="text-[10px] font-semibold uppercase tracking-[0.16em] text-white/35">Monthly</div>
              <div className="mt-1 text-lg font-semibold text-white">
                {pricing?.[size]?.price && pricing[size].price > 0 ? `$${pricing[size].price.toFixed(2)}/mo` : "Free"}
              </div>
            </div>
          </div>
        </div>
