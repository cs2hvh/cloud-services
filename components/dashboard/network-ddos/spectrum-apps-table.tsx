    ...
    return (
      ...
      >
        ...
        <p className="relative z-10 mt-2 max-w-md mx-auto font-[var(--font-geist-mono),ui-monospace,monospace] text-[11.5px] text-white/45 leading-relaxed">
          Configure your first Spectrum application to route and protect
          Layer 4 traffic at the Cloudflare edge.
        </p>
  ...
  return (
    <>
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
        {isDeleting ? (
          <div className="flex h-48 items-center justify-center border border-white/[0.06] bg-[#111216] rounded-[6px]">
