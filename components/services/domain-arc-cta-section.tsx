    ...
    <section className="relative overflow-hidden bg-[#202124] pt-16 sm:pt-20 lg:pt-24">
      ...
      <Container className="relative z-10">
        <div className="mx-auto flex max-w-[760px] flex-col items-center text-center">
          ...
          >
            ahura <span className="text-[#0095FF]">cloud</span>
          </span>

          <h2
            style={{
              background: "linear-gradient(180deg, #FFFFFF 0%, #0017FF 100%)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
            }}
            className="mt-6 text-3xl font-semibold leading-tight text-[#D8D8E8] sm:text-4xl lg:text-[48px]"
          >
            Own Your Domain
            <span className="block text-[#2F5CFF]">
              Power Your Online Presence
            </span>
          </h2>

          <p className="mt-4 max-w-[680px] text-sm leading-relaxed text-white/65 sm:text-base">
            Find the right name, connect it to your infrastructure, and manage
            everything from one reliable platform. Simple registration, smart
            DNS tools, and dependable security for every stage of growth.
          </p>
        </div>
      </Container>
      ...
      /> */}
    <div
  className="pointer-events-none absolute left-1/2 bottom-[-270px] h-[420px] w-[150%] -translate-x-1/2 scale-x-[-1] rounded-[50%] border-t border-[#E5EBFF]/90 bg-[radial-gradient(ellipse_at_center,rgba(61,93,255,0.38),rgba(37,52,100,0.18)_48%,rgba(8,10,14,0)_72%)] shadow-[0_-8px_60px_rgba(66,95,255,0.45)]"
  aria-hidden="true"
/>
      <div
