...
import OverviewTab from "@/components/admin/linode/overview-tab";
import PlansTab from "@/components/admin/linode/plans-tab";
import RegionsTab from "@/components/admin/linode/regions-tab";
import ImagesTab from "@/components/admin/linode/images-tab";
import InstancesTab from "@/components/admin/linode/instances-tab";
