...
**Date:** 2026-07-08 · **Companion to:** [11-agent-implementation-plan.md](11-agent-implementation-plan.md) (agentcore) · [14-agent-mcp-implementation.md](14-agent-mcp-implementation.md) (MCP tools) · **Status:** built, unit-tested, typecheck clean. **3 migrations written, none applied yet** — you run them in order.
