...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log(body, "...........in update database status api........");
        ...
        const host_public=(await resolveHost(body.public_connection.host)).records[0].records[0] || body.public_connection.host;
      console.log(host_public,".............database host ip.............");
      const host_private=(await resolveHost(body.private_connection.host)).records[0].records[0] || body.private_connection.host;
    ...
    console.log(`https://api.digitalocean.com/v2/databases/${body.id}/ca`,"...........fetch ca certificate url...........");
    ...
    console.log(database,"............database ca certificate response...........");
    ...
    if(database.status===200){
      ...
      const supabase_read = await Database_Clusters.update_status(
            body.id, "online",caCertificate,body.public_connection,body.private_connection
