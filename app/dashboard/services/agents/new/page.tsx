...
import { Loader2, Plus, Bot, Cpu, Layers, DollarSign, Shield, Wrench, Sparkles } from 'lucide-react';
    ...
    try {
      const r = await fetch('/api/agents', {
        ...
        body: JSON.stringify({
          ...
          guardrail, max_steps: maxSteps, max_cost_cents: maxCost, tools: buildToolsPayload(tools, fileSearchCollectionId),
        }),
      });
