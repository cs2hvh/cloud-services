      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          {protectionApplications.length > 0 ? (
            <div>
              {/* Search bar */}
              <div className="bg-neutral-900 border border-neutral-800 p-4 rounded-lg mb-4">
                <div className="flex items-center w-full max-w-md">
                  <Search className="w-4 h-4 text-neutral-500 mr-3"/>
                  <input 
                    type="text" 
                    placeholder="Search protected applications..." 
                    className="w-full bg-transparent focus:outline-none text-white text-sm placeholder-neutral-500"
                  />
                </div>
              </div>
            ...
            <div className="bg-neutral-900 border border-neutral-800 border-dashed rounded-lg">
