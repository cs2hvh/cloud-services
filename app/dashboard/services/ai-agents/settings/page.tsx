  ...
  return (
    <div className="space-y-5 px-2 py-4 text-white sm:px-3 lg:px-4">
      <div className="glass-panel overflow-hidden">
        ...
        <div className="flex flex-col gap-5 px-5 py-5 sm:px-6 sm:py-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex items-center gap-5">
            <Image src={assetUrl("/dashboard-services-icons/da ai aniamtion.png")} alt="" width={72} height={72} className="shrink-0 opacity-80 hidden lg:block"  unoptimized />
            <Button variant="outline" asChild className="rounded-none border-white/[0.1] bg-white/[0.03] text-white/80 hover:bg-white/[0.08]">
              <Link href="/dashboard/services/ai-agents">
                <Image src={assetUrl("/dashboard-icons/settings-1.png")} alt="" width={14} height={14} className="mr-2 opacity-70"  unoptimized />
                Back to agents
              </Link>
            </Button>
          </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <div className="glass-panel p-5"><div className="flex items-start justify-between gap-4"><div><p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-white/35">Model Keys</p><p className="mt-3 text-2xl font-semibold text-white">{keys.length}</p><p className="mt-1 text-sm text-white/45">Saved provider credentials</p></div><Image src={assetUrl("/dashboard-icons/model-keys.png")} alt="Model Keys" width={36} height={36} className="shrink-0 opacity-80"  unoptimized /></div></div>
        <div className="glass-panel p-5"><div className="flex items-start justify-between gap-4"><div><p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-white/35">Valid Keys</p><p className="mt-3 text-2xl font-semibold text-white">{validModelKeys}</p><p className="mt-1 text-sm text-white/45">Providers ready for agent deployment</p></div><Image src={assetUrl("/dashboard-icons/valid-keys.png")} alt="Valid Keys" width={36} height={36} className="shrink-0 opacity-80"  unoptimized /></div></div>
        <div className="glass-panel p-5"><div className="flex items-start justify-between gap-4"><div><p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-white/35">Agent API Keys</p><p className="mt-3 text-2xl font-semibold text-white">{activeAgentKeys}</p><p className="mt-1 text-sm text-white/45">Active endpoint credentials - {totalAgentRequests} requests</p></div><Image src={assetUrl("/dashboard-icons/agent-api-keys.png")} alt="Agent API Keys" width={36} height={36} className="shrink-0 opacity-80"  unoptimized /></div></div>
      </div>
        ...
        <DialogContent className="glass-panel overflow-hidden border border-white/[0.08] bg-[#050816] text-white sm:max-w-md [&>button]:rounded-none">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <Image src={assetUrl("/dashboard-icons/valid-keys.png")} alt="" width={18} height={18} className="opacity-90"  unoptimized />
              API Key Created
            </DialogTitle>
            <DialogDescription>
      ...
      <Tabs defaultValue="model-keys" className="space-y-6">
        <TabsList className="grid w-full grid-cols-2 rounded-none border border-white/[0.08] bg-white/[0.04] p-1 sm:w-fit">
          <TabsTrigger value="model-keys" className="rounded-none text-white/60 data-[state=active]:bg-blue-500/90 data-[state=active]:text-white">
            <Image src={assetUrl("/dashboard-icons/model-keys.png")} alt="" width={14} height={14} className="mr-1.5 opacity-70"  unoptimized />
            Model API Keys
          </TabsTrigger>
          <TabsTrigger value="agent-api-keys" className="rounded-none text-white/60 data-[state=active]:bg-blue-500/90 data-[state=active]:text-white">
            <Image src={assetUrl("/dashboard-icons/agent-api-keys.png")} alt="" width={14} height={14} className="mr-1.5 opacity-70"  unoptimized />
            Agent API Keys
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="model-keys" className="space-y-6">
            ...
            <div className="flex items-center justify-between border-b border-white/[0.06] px-5 py-4 sm:px-6">
              <div>
                <h3 className="text-base font-semibold text-white flex items-center gap-2">
                  <Image src={assetUrl("/dashboard-icons/model-keys.png")} alt="" width={18} height={18} className="opacity-80"  unoptimized />
                  Model API Keys
                </h3>
            ...
            <div className="space-y-4 p-5 sm:p-6">
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      <Button onClick={handleAddKey} disabled={saving} className="rounded-none border border-blue-400/25 bg-blue-500/90 text-white hover:bg-blue-500">
                        {saving ? (
                          ...
                          <>
                            <Image src={assetUrl("/dashboard-icons/valid-keys.png")} alt="" width={14} height={14} className="mr-2 opacity-80"  unoptimized />
                            Add Key
                          </>
                        )}
                      </Button>
              ...
              {loading ? (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        <div className="p-2 bg-white/[0.06] border border-white/[0.08]">
                          <Image src={assetUrl("/dashboard-icons/valid-keys.png")} alt="" width={16} height={16} className="opacity-75"  unoptimized />
                        </div>
                        <div>
                          <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-3">
                        {key.is_valid ? (
                          <Badge className="rounded-none bg-green-500/20 text-green-400 border-green-500/30">
                            <Image src={assetUrl("/dashboard-icons/healthy.png")} alt="" width={10} height={10} className="mr-1 opacity-90"  unoptimized />
                            Valid
                          </Badge>
                        ) : (
                ...
                <div className="text-center py-8">
                  <Image src={assetUrl("/dashboard-icons/model-keys.png")} alt="No keys" width={48} height={48} className="opacity-25 mx-auto mb-4"  unoptimized />
          ...
          <div className="glass-panel overflow-hidden">
            <div className="border-b border-white/[0.06] px-5 py-4 sm:px-6">
              <h3 className="text-base font-semibold text-white flex items-center gap-2">
                <Image src={assetUrl("/dashboard-icons/model.png")} alt="" width={18} height={18} className="opacity-80"  unoptimized />
                Supported Providers
              </h3>
        ...
        <TabsContent value="agent-api-keys" className="space-y-5">
          <div className="glass-panel overflow-hidden">
            <div className="flex items-center justify-between border-b border-white/[0.06] px-5 py-4 sm:px-6">
              <div>
                <h3 className="text-base font-semibold text-white flex items-center gap-2">
                  <Image src={assetUrl("/dashboard-icons/agent-api-keys.png")} alt="" width={20} height={20} className="opacity-80"  unoptimized />
                  Agent API Keys
                </h3>
                <p className="mt-1 text-sm text-white/45">
            ...
            <div className="space-y-4 p-5 sm:p-6">
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      <Button onClick={handleAddAgentKey} disabled={savingAgentKey} className="rounded-none border border-blue-400/25 bg-blue-500/90 text-white hover:bg-blue-500">
                        {savingAgentKey ? (
                          ...
                          <>
                            <Image src={assetUrl("/dashboard-icons/agent-api-keys.png")} alt="" width={14} height={14} className="mr-2 opacity-80"  unoptimized />
                            Create Key
                          </>
                        )}
                      </Button>
              ...
              {loadingAgentKeys ? (
                ...
                <div className="space-y-2">
                  {agentApiKeys.map((key) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        <div className="p-2 bg-white/[0.06] border border-white/[0.08]">
                          <Image src={assetUrl("/dashboard-icons/agent-api-keys.png")} alt="" width={16} height={16} className="opacity-75"  unoptimized />
                        </div>
                        <div>
                          <div className="flex items-center gap-2">
                            <p className="text-white font-medium">{key.name}</p>
                ...
                <div className="text-center py-8">
                  <Image src={assetUrl("/dashboard-icons/agent-api-keys.png")} alt="No keys" width={48} height={48} className="opacity-25 mx-auto mb-4"  unoptimized />
          ...
          <div className="glass-panel overflow-hidden">
            <div className="border-b border-white/[0.06] px-5 py-4 sm:px-6">
              <h3 className="text-base font-semibold text-white flex items-center gap-2">
                <Image src={assetUrl("/dashboard-icons/configure.png")} alt="" width={18} height={18} className="opacity-80"  unoptimized />
                API Documentation
              </h3>
